...
After installing or upgrading the package, run `jenkins-cli skill install` and
reload the agent context. `jenkins-cli skill status` reports version alignment.
