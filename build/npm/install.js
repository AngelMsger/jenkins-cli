...
function binPath(platform = process.platform) {
  ...
  const exe = platform === 'win32' ? 'jenkins-cli.exe' : 'jenkins-cli';
...
function welcomeText() {
  return [
    '',
    'jenkins-cli is ready. After every install or upgrade:',
    '',
    '  jenkins-cli skill install          install or refresh the coding-agent Skill',
    ...
    '  jenkins-cli build list <job-path>',
    '  jenkins-cli --help',
    '',
