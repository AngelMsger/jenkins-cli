// Package update reports whether a newer jenkins-cli release is available.
//
...
const DefaultEndpoint = "https://api.github.com/repos/AngelMsger/jenkins-cli/releases/latest"

// releasesPage is the human URL shown in the update detail.
const releasesPage = "https://github.com/AngelMsger/jenkins-cli/releases/latest"
...
const EndpointEnv = "JENKINS_RELEASE_API"
