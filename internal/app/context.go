...
// configured format, for large or unbounded listings where a single buffered
// JSON blob would be unwieldy.
...
// Jenkins endpoints used in v0.1 are unpaginated, so HasMore is always
