...
| [`jenkins-cli skill path`](https://angelmsger.github.io/jenkins-cli/cli/#jenkins-cli-skill-path) | Print Skill paths, installation state and version alignment |
...
| [`jenkins-cli skill status`](https://angelmsger.github.io/jenkins-cli/cli/#jenkins-cli-skill-status) | Report loaded, installed and embedded Skill versions |
